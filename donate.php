    ...
    if(isset($_POST['term']) === true){
     ...
     <button type="button" class="close" data-dismiss="alert" aria-label="Close">
      ...
      if(isset($_POST['contact_no']) && !empty($_POST['contact_no'])){
       ...
       <strong>Contact should be of 10 numbers.</strong>
       <button type="button" class="close" data-dismiss="alert" aria-label="Close">
         <span aria-hidden="true">&times;</span>
       </button>
     </div>';
     ...
     <button type="button" class="close" data-dismiss="alert" aria-label="Close">
      ...
      && isset($city) || isset($referencename) || isset($referencecontact) && isset($password) && isset($blood_group)){
        ...
        $sql = "INSERT INTO donor (
          image,name,link,gender,email,city,dob,contact_no,save_life_date,password,blood_group)
          VALUES ('$image','$name', '$link' ,'$gender','$email','$city','$DonorDOB','$contact','0','$password','$blood_group')";
...
<div class="container-fluid red-background size">
	<div class="row">
		<div class="col-md-6 offset-md-3">
			...
			<hr class="white-bar">
      <h2  style="color:white"class="text-center">Donate Blood, Save Lives – Be Sure, Be Safe</h2>
		</div>
	</div>
</div>
          ...
          <div class="form-group">
            ...
            value="<?php if(isset($link)) echo $link; ?>">
             ...
             <?php if(isset($linkError)) echo $linkError; ?>
              ...
              <option value="2001" >2001</option><option value="2002" >2002</option><option value="2003" >2003</option><option value="2004" >2004</option></select>
            </div><!--End form-group-->
            ...
            <?php if(isset($emailError)) echo $emailError; ?>
              ...
              <input type="text" name="contact_no" placeholder="+977*********" class="form-control" required pattern="^\d{10}$" title="10 numeric characters only" maxlength="10" value="<?php if(isset($contact)) echo $contact; ?>" >
            ...
            <div class="form-inline">
              ...
              <span style="margin-left:10px;"><b>I agree to share all my information</b></span>
            </div><!--End form-group-->
